...
static QApplication *createApplication(int &argc, char **argv, const QString &applicationName)
{
    ...
    QApplication::setOrganizationName("matsyaos");
    QApplication::setApplicationName(applicationName);
    QApplication::setOrganizationDomain("matsyaos.com");
    QApplication::setApplicationDisplayName("Video Player");
    QApplication::setWindowIcon(QIcon::fromTheme("matsya-videoplayer"));
    ...
    : m_app(createApplication(argc, argv, applicationName))
{
    ...
    QString mspris2Name(QStringLiteral("org.mpris.MediaPlayer2.matsya.videoplayer"));
    ...
    // Translations
    QLocale locale;
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/matsya-videoplayer/translations/").arg(locale.name());
